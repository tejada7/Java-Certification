...
public class Miscellaneous {
    ...
    static int pow(int number, int base) {
        ...
        return number * pow(number, --base);
    }

    private static void function36() {
        ...
        int[] systemCopy = new int[array.length];
        System.arraycopy(array, 0, systemCopy, 0, array.length);
        System.out.println(Arrays.equals(array, systemCopy));
    ...
    private static void function35() {
        System.out.println(Integer.toBinaryString(~0b01)); // 11
        System.out.println(Integer.toBinaryString(0b11)); // 11
        System.out.println(Integer.toBinaryString(0b11 | ~0b01)); // 11
        System.out.println(0b11 | ~0b01); // 11
        ForaxInterface.main(null);
    }
    ...
    interface ForaxInterface {
        static void main(String...args) {
            ...
            System.out.println(fun.apply(-1636202894));
        }
    }
...
//        i = f;
        ...
        List<Integer> list1 = listOfList.stream().flatMap(Collection::stream).collect(Collectors.toList());
    }
